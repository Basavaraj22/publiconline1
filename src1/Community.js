...
export default class Community extends Component{  
    constructor(props) {
     ...
     GetItem () {
      ...
      webCall=()=>{
       ...
       return fetch('https:/publiconline.in/User/getBasic')
    ...
    render() {  
       ...
       renderItem={({item}) => 
                    ...
                    /* <Card style={styles.rectangle105} onPress={() =>  this.props.navigation.navigate('San')}>
                        ...
                        <View style={{flexDirection:'row',marginTop:'5%',marginLeft:'8%'}}>
                            <Icon  size={25} name='briefcase'/>
                            <Text style={{fontSize:width/30,fontWeight:'700',marginLeft:'3%',marginTop:'1%',color:'#CCCCCC'}}>Business Services</Text>
                        </View>
                        <View style={{flexDirection:'row',marginTop:'0%',marginLeft:'8%'}}>
                            <Text style={{fontSize:width/25,fontWeight:'700',marginTop:'2%',color:'#000000'}}>Sanhalasoftwares</Text>
                            <Icon  size={25} color='green' name='check-circle'style={{marginLeft:'3%',marginTop:'2%'}}/>
                        </View>
